            ...
            while (true) {
                ...
                if (idConnection == 0) {
                    ...
                    try {
                        ...
                        if ("O".equals(reponse.toUpperCase())) {
                    ...
                    try {
                        ...
                        if (!this.serveur.getUsers().containsKey(this.nom)) {
                            ...
                            if (user.equals(this.nom)) {
                                outputStream.writeObject(
                                        "Vous ne pouvez pas vous abonner à vous-même\n");

                            } else if (this.serveur.getUsers().get(this.nom).contains(user)) {
                                outputStream.writeObject(
                                        "Vous êtes déjà abonné à " + user + "\n");
                            } else if (this.serveur.getUsers().containsKey(user)) {
